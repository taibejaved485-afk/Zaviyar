          ...
          {stats.map((stat, idx) => (
            ...
            >
              <div className="flex justify-center mb-6 relative">
                ...
                <div className="relative p-4 bg-white rounded-2xl border border-slate-200 text-indigo-600 group-hover:text-white group-hover:bg-indigo-600 group-hover:border-indigo-500 transition-all duration-300 shadow-lg group-hover:shadow-indigo-500/20">
                  {stat.icon}
                </div>
              </div>
              
              <div className="relative">
                <div className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-2 tabular-nums tracking-tight">
